...
const DELHI_MONUMENT_IMAGES = {
  red_fort: "/assets/images/markers/Red Fort.png",
  india_gate: "/assets/images/markers/india gate.png",
  qutub_minar: "/assets/images/markers/qutub minar .png",
  humayun_tomb: "/assets/images/markers/humayun tomb.png",
  lotus_temple: "/assets/images/markers/lotus temple .png",
  akshardham: "/assets/images/markers/akshardham.png",
  jama_masjid: "/assets/images/markers/Jama masjid.webp",
  rashtrapati_bhavan: "/assets/images/markers/rashtrapati bhavan.png",
};

// Place/monument id → at most one video each (direct MP4 URL or project-relative path).
const PLACE_VIDEOS = {
  red_fort: [],
  india_gate: [{ url: "/assets/videos/India gate.mp4", title: "India Gate" }],
  qutub_minar: [],
  humayun_tomb: [],
  lotus_temple: [],
  akshardham: [],
...
const PLACE_DETAILED_INFO = {
  supermax_gate: {
    ...
    detailPageUrl: "/pages/indexflat.html",
  },
  fims_hospital: {
    image: "",
    summary:
    ...
    detailPageUrl: "/pages/indexhos.html",
  },
  iiit_sonepat: {
    image: "",
    summary:
  ...
  red_fort: {
    image: "/assets/images/markers/Red Fort.png",
    summary:
  ...
  india_gate: {
    image: "/assets/images/markers/india gate.png",
    summary:
  ...
  qutub_minar: {
    image: "/assets/images/markers/qutub minar .png",
    summary:
  ...
  humayun_tomb: {
    image: "/assets/images/markers/humayun tomb.png",
    summary:
  ...
  lotus_temple: {
    image: "/assets/images/markers/lotus temple .png",
    summary:
    ...
    detailPageUrl: "/pages/monuments-3d.html?monument=lotus_temple",
  },
  akshardham: {
    image: "/assets/images/markers/akshardham.png",
    summary:
  ...
  jama_masjid: {
    image: "/assets/images/markers/Jama masjid.webp",
    summary:
  ...
  rashtrapati_bhavan: {
    image: "/assets/images/markers/rashtrapati bhavan.png",
    summary:
...
window.openPlaceModal = function (placeId) {
  if (placeId === "fims_hospital") {
    window.location.href = "/pages/fims-hospital.html";
    return;
  }
  const place =
...
function initMap() {
  ...
  fetch("/assets/data/delhi-metro-data.csv")
    .then(function (r) {
      return r.text();
    })
